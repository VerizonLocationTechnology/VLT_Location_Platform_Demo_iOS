...
var apiKey: String = ""
var globalUnitSystem = UnitSystem.imperial

@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate {
    // MARK: - Private Members
    /// Typealias to string literals for this file
    fileprivate typealias VCLiterals = VLTLiterals.AssetNameLiterals
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if let path = Bundle.main.path(forResource: "Info", ofType: ".plist"),
            ...
            let vltApiKey = dict[VCLiterals.apiKeyLocation] as? String {
            apiKey = vltApiKey
        }

        /// Application theming
        if let primaryColor = UIColor(named: VCLiterals.primaryColor),
            ...
            if let originalImage = UIImage(systemName: VCLiterals.leftChevronImage), let backImage = originalImage.cgImage {
