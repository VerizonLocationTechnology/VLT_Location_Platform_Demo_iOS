    ...
    func addMarkers() {
        ...
        do {
            ...
            if let customImage = UIImage(named: VLTLiterals.AssetNameLiterals.customDestinationImage) {
                ...
                let customImage = VLTImage(image: customImage, imageName: literals.customMarkerImageName)
        ...
        do {
            for (index, marker) in markers.enumerated() {
                ...
                if marker.image == vltCustomImage {
                    marker.image = VLTMaps.ShapeConstants.Defaults.markerImage
                } else {
